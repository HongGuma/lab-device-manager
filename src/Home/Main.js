...
class Main extends React.Component{
    constructor(props) {
        ...
        this.state= {
            ...
            url:{
                0:'http://210.218.217.110:3103/api/getOfficeEntry.php',
                1:'http://210.218.217.110:3103/api/getDiskEntry.php',
                2:'http://210.218.217.110:3103/api/getLabEntry.php',
                3:'http://210.218.217.110:3103/api/getSampleEntry.php',
            },
            currentID: 0,
            currentTit: '사무용품',
            currentURL: '',
