    ...
    return (
        <section className="container">
            ...
            <div className="container-cont">
                {isDefault && <Default itemList={list} titleList={tit} onCheckSingle={onCheckSingle} onCheckAll={onCheckAll} checkedList={checkedItems} allChecked={isAllChecked}/> }
                {/*{isUpdate && <UpdateItem itemList={list} titleList={tit} changeHandler={inputHandler}/> }*/}
                {isUpdate && <Update item={updateItem} titleList={tit} changeHandler={inputHandler} setUpdate={setUpdate} setDefault={setDefault} setDoneUpdate={setDoneUpdate}/> }
                {isInsert && <Insert list={list} changeHandler={inputHandler} clickEvent={onClickInsert}/> }
            </div>
        </section>
