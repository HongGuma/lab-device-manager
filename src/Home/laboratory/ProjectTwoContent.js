...
const HiddenTab = ({clickEvent}) => {
    ...
    return(
        <div className="hidden-tab">
            <div className="tabs">
                <p className={currentNum===1?'active':''} onClick={()=>clickTab(1)}>tab1</p>
                <p className={currentNum===2?'active':''} onClick={()=>clickTab(2)}>tab2</p>
                <p className={currentNum===3?'active':''} onClick={()=>clickTab(3)}>tab3</p>
                <p className={currentNum===4?'active':''} onClick={()=>clickTab(4)}>tab4</p>
            </div>
