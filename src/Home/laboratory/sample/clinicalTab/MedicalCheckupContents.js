...
const InsertMedicalCheckup = ({medicalEntry,URL}) => {
    const [insertItem,setInsertItem] = useState({
        ...
        r_51:'-',r_52:'-',r_53:'-',r_54:'-',r_55:'-',r_56:'-',r_57:'-',r_58:'-',r_59:'-',r_60:'-',
        r_61:'-',r_62:'-',r_63:'-',r_64:'-',r_65:'-',r_66:'-',r_67:'-',r_68:'-',r_69:'-',r_70:'-',
        r_71:'-',r_72:'-',r_73:'-',r_74:'-',r_75:'-',r_76:'-',r_77:'-',r_78:'-',r_79:'-',r_80:'-',
        r_81:'-',r_82:'-',r_83:'-',r_84:'-',r_85:'-',r_86:'-',r_87:'-',r_88:'-',r_89:'-',r_90:'-',
        r_91:'-',r_92:'-',r_93:'-',r_94:'-',r_95:'-',r_96:'-',r_97:'-',r_98:'-',r_99:'-',r_100:'-',
        r_101:'-',r_102:'-',r_103:'-',r_104:'-',r_105:'-',r_106:'-',r_107:'-',r_108:'-',r_109:'-',r_110:'-',
        r_111:'-',r_112:'-',r_113:'-',r_114:'-',r_115:'-'
    })

    const { r_1,r_2,r_3,r_4,r_5,r_6,r_7,r_8,r_9,r_10,r_11,r_12,r_13,r_14,r_15,r_16,r_17,r_18,r_19,r_20,r_21,r_22,r_23,r_24,r_25,r_26,r_27,r_28,r_29,r_30,
        r_31,r_32,r_33,r_34,r_35,r_36,r_37,r_38,r_39,r_40,r_41,r_42,r_43,r_44,r_45,r_46,r_47,r_48,r_49,r_50,r_51,r_52,r_53,r_54,r_55,r_56,r_57,r_58,r_59,r_60,
        r_61,r_62,r_63,r_64,r_65,r_66,r_67,r_68,r_69,r_70,r_71,r_72,r_73,r_74,r_75,r_76,r_77,r_78,r_79,r_80,r_81,r_82,r_83,r_84,r_85,r_86,r_87,r_88,r_89,r_90,
        r_91,r_92,r_93,r_94,r_95,r_96,r_97,r_98,r_99,r_100,r_101,r_102,r_103,r_104,r_105,r_106,r_107,r_108,r_109,r_110,r_111,r_112,r_113,r_114,r_115} = insertItem;
            ...
            <ul className="insert-ul">
                {
                    medicalEntry.map((item)=>(
                        <li><input type="textbox" name={"r_1"+item.id} onChange={(e)=>insertHandler(e)}/></li>
                    ))
                }
            </ul>
            <ul className="insert-btn" onClick={onClick}><li>저장</li></ul>
        </div>
    )
}
...
const MedicalCheckupContents = ({URL,medicalPosts,currentEntry,onCheckSingle,onCheckAll,checkedItems,checkedAll,isInsertToggle,isDeleteToggle}) => {
    ...
    const ContentsComponent = ({item}) => {
        const medicalItem = Object.values(item);
        return(
            medicalEntry.map((entry,idx)=>(
                     <li>{medicalItem[idx+1]}</li>
            ))
    ...
    return(
        <section className="medical-section">
            ...
            {isInsertToggle &&  <InsertMedicalCheckup URL={URL} medicalEntry={medicalEntry} />}
        </section>
    )
}
