...
const InsertConsent = ({ URL, consentEntry }) => {
  ...
  return (
    <div>
      ...
      <ul className="insert-btn">
        <li onClick={onClickInsertBtn}>저장</li>
      </ul>
    </div>
  );
};
...
const ConsentContents = ({
  ...
  return (
    <section className="consent-section">
        ...
        {consentPosts.map((item) => (
          ...
          >
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_1" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_1", item.r_1)
                }
              >
                {item.r_1}
              </li>
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_2" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_2", item.r_2)
                }
              >
                {item.r_2}
              </li>
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_3" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_3", item.r_3)
                }
              >
                {item.r_3}
              </li>
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_4" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_4", item.r_4)
                }
              >
                {item.r_4}
              </li>
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_5" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_5", item.r_5)
                }
              >
                {item.r_5}
              </li>
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_6" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_6", item.r_6)
                }
              >
                {item.r_6}
              </li>
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_7" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_7", item.r_7)
                }
              >
                {item.r_7}
              </li>
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_8" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_8", item.r_8)
                }
              >
                {item.r_8}
              </li>
            ...
            {dubleClickedID === item.id && dubleClickedItem === "r_9" ? (
              ...
              <li
                onDoubleClick={() =>
                  onDubleClickToggle(item.id, "r_9", item.r_9)
                }
              >
                {item.r_9}
              </li>
      ...
      {isInsertToggle && (
        <InsertConsent URL={URL} consentEntry={consentEntry} />
      )}
    </section>
  );
};
